      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto animate-fade-in-up">
          ...
          <p className="font-sans text-sm md:text-base tracking-[0.12em] text-white/75 font-light max-w-lg mx-auto mb-10 leading-relaxed">
            Where artistry meets elegance. Premium hair care and styling crafted
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/40">
          <span className="font-sans text-[0.6rem] tracking-[0.2em] uppercase">
            Scroll
          </span>
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              <p className="font-serif text-4xl font-light text-[var(--gold-light)] mb-1">
                {stat.value}
              </p>
              <p className="font-sans text-[0.65rem] tracking-[0.15em] uppercase text-background/50 font-medium">
                {stat.label}
              </p>
            </div>
          ))}
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-sans text-sm text-muted-foreground leading-relaxed mb-6">
              The Blush is more than a salon — it is a sanctuary where skilled
              artistry and genuine care converge. Our master stylists bring over
              a decade of expertise to every appointment, ensuring each client
              leaves feeling transformed and confident.
            </p>
            <p className="font-sans text-sm text-muted-foreground leading-relaxed mb-10">
              From precision haircuts to luxurious treatments, every service is
              delivered with meticulous attention to detail and a deep
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="font-sans text-sm text-white/65 leading-relaxed mb-10 max-w-xl mx-auto">
            From classic cuts to transformative color and rejuvenating
            treatments — every service is a masterpiece.
          </p>
          <Link
            to="/services"
      ...
      <section className="py-24 px-6 bg-[var(--cream-dark)]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="font-sans text-sm text-muted-foreground leading-relaxed mb-10 max-w-lg mx-auto">
            Browse real transformations from our valued clients. Every photo
            tells a story of confidence and artistry.
          </p>
          <Link
            to="/gallery"
      ...
      <section className="py-24 px-6 bg-foreground">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="font-sans text-[0.65rem] tracking-[0.25em] uppercase font-semibold text-[var(--gold-light)] mb-4">
              Our Space
            </p>
            <h2 className="font-serif text-5xl font-light text-white mb-6">
              Inside The Blush
          ...
          <div className="text-center mt-12">
            <Link
              to="/gallery"
              className="inline-flex items-center gap-2 font-sans text-xs tracking-[0.2em] uppercase font-semibold text-[var(--gold-light)] hover:text-[var(--gold)] transition-colors duration-200"
            >
              See Client Transformations <ChevronRight size={14} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-background">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-5xl font-light text-foreground mb-4">
              Visit The Blush
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex gap-5">
                ...
                <div>
                  <p className="font-sans text-[0.65rem] tracking-[0.2em] uppercase font-semibold text-[var(--gold)] mb-1">
                    Address
                  </p>
            ...
            <div className="border border-border p-8 bg-card">
              ...
              <p className="font-sans text-xs text-muted-foreground leading-relaxed mb-6">
                We believe beauty is not just about appearance — it's about how
                you feel. Our team is dedicated to making every appointment an
