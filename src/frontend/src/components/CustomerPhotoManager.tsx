    ...
    <div className="space-y-10">
      ...
      <div className="border border-border bg-card p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="customer-review" className={labelClass}>
              Review
            </label>
            <textarea
              id="customer-review"
          ...
          <div>
            <span className={labelClass} style={{ display: "block" }}>
              Photo
            </span>
            <label
              htmlFor="customer-photo"
              className="border-2 border-dashed border-border hover:border-[var(--gold)]/50 transition-colors duration-200 p-8 text-center cursor-pointer block"
            >
              <input
                ref={fileInputRef}
                id="customer-photo"
          ...
          {addMutation.isPending && uploadProgress > 0 && (
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="font-sans text-xs text-[var(--gold)]">
                  {uploadProgress}%
                </span>
              </div>
