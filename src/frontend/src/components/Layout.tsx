    ...
    <footer className="bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-serif text-xl tracking-widest text-background">
                THE BLUSH
              </span>
            </div>
            <p className="font-sans text-xs tracking-wide text-background/60 leading-relaxed max-w-xs">
              Where artistry meets elegance. Premium hair care and styling in
              the heart of Kharghar.
            </p>
          </div>
        ...
        <div className="border-t border-background/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="font-sans text-[0.65rem] tracking-wide text-background/40">
            Built with <span className="text-[var(--gold-light)]">♥</span> using{" "}
            <a
