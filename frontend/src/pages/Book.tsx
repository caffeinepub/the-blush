...
import { MapPin, Clock, CheckCircle, Lightbulb } from 'lucide-react';
          ...
          <aside className="space-y-8">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <CheckCircle size={14} strokeWidth={1.5} className="text-[var(--gold)] mt-0.5 flex-shrink-0" />
            ...
            <div className="border border-border p-8 bg-card">
              ...
              <div className="flex gap-3 mb-4">
                <MapPin size={14} strokeWidth={1.5} className="text-[var(--gold)] mt-0.5 flex-shrink-0" />
              ...
              <div className="flex gap-3">
                <Clock size={14} strokeWidth={1.5} className="text-[var(--gold)] mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-sans text-xs text-muted-foreground">Open Every Day</p>
                  <p className="font-sans text-xs text-muted-foreground">9:30 AM – 10:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-[var(--gold)]/30 p-8 bg-[var(--cream-dark)]">
              <div className="flex items-center gap-2 mb-3">
                <Lightbulb size={14} strokeWidth={1.5} className="text-[var(--gold)]" />
                <p className="font-sans text-[0.65rem] tracking-[0.2em] uppercase font-semibold text-[var(--gold)]">
                  Pro Tip
                </p>
              </div>
              <p className="font-sans text-xs text-muted-foreground leading-relaxed">
                Arrive 5–10 minutes early for a relaxed consultation. For color services, avoid washing your hair 24 hours before your appointment.
              </p>
            </div>
          </aside>
        </div>
